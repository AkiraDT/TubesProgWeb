    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="Sektor.php">Kebun Binatang
</a>
            </div>
             ...
             <div class="col-lg-12">
                  <h2>Add new Records</h2>
                      <div class="col-lg-6">
                        ...
                        <form role="form" method="post" action="Sektor-proc.php?action=add">
                            
                            <div class="form-group">
                              <input class="form-control" placeholder="Kode Sektor" name="kd_sektor" id="kd_sektor">
                            </div>                            
                            <div class="form-group">
                              <input class="form-control" placeholder="Nama Sektor" name="nama_sektor" id="nama_sektor">
                            </div>
                            <div class="form-group">
                              <input class="form-control" placeholder="Kordinat X" name="koordinatx_sektor" id="koordinatx_sektor">
                            </div> 
                            <div class="form-group">
                              <input class="form-control" placeholder="Kordinat Y" name="koordinaty_sektor" id="koordinaty_sektor">
                            </div>                            
