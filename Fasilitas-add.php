             ...
             <div class="col-lg-12">
                  <h2>Add new Records</h2>
                      <div class="col-lg-6">
                        ...
                        <form role="form" method="post" action="Fasilitas-proc.php?action=add">
                            
                            <div class="form-group">
                              <input class="form-control" placeholder="Kode Fasilitas" name="kd_fasilitas" id="kd_fasilitas">
                            </div>                            
                            <div class="form-group">
                              <input class="form-control" placeholder="Kode Sektor" name="kd_sektor" id="kd_sektor">
                            </div>
                            <div class="form-group">
                              <input class="form-control" placeholder="Nama Fasilitas" name="nama_fasilitas" id="nama_fasilitas">
                            </div>                             
