    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="Kandang.php">Kebun Binatang
</a>
            </div>
             ...
             <div class="col-lg-12">
                  <h2>Kandang</h2>
                      <div class="col-lg-6">
                        ...
                        <form role="form" method="post" action="Kandang-proc.php?action=add">
                            
                            <div class="form-group">
                              <input class="form-control" placeholder="Kode Kandang" name="kd_kandang" id="kd_kandang">
                            </div>                            
                            <div class="form-group">
                              <input class="form-control" placeholder="Nama Kandang" name="nama_kandang" id="nama_kandang">
                            </div>
                            <div class="form-group">
                              <input class="form-control" placeholder="Tipe Kandang" name="tipe_kandang" id="tipe_kandang">
                            </div> 
                            <div class="form-group">
                              <input class="form-control" placeholder="Populasi Kandang" name="populasi_kandang" id="populasi_kandang">
                            </div>
                            <div class="form-group">
                              <input class="form-control" placeholder="Kode Sektor" name="kd_sektor" id="kd_sektor">
                            </div>                         
